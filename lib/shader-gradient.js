  ...
  class ShaderGradientController {
    ...
    start() {
      ...
      this.sampleTimer = setInterval(() => {
        if (!this.options.isStatic && !this.customImage) {
          this.extractColorsFromVideo();
        }
    ...
    /**
     * 从当前封面图片或视频帧提取最具表现力且彼此和谐的 4 种主色
     */
    extractColorsFromVideo() {
      ...
      try {
        this.sampleCtx.clearRect(0, 0, 12, 12);
        this.sampleCtx.drawImage(source, 0, 0, 12, 12);
